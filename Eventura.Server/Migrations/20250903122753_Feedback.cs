        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image1ContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image2 = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    Image2ContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    Image3 = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    Image3ContentType = table.Column<string>(type: "nvarchar(max)", nullable: true),
